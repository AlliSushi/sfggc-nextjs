...
const resolveSampleDataDir = () => {
  const portalDocsPath = path.join(process.cwd(), "portal_docs", "sample_data");
...
export { getAllParticipants, getAllParticipantIds, getParticipantByPid };
